...
local function toggle_boolean_simple()
	...
	if replacements[word] then
		vim.cmd.normal('"_ciw' .. replacements[word])
	else
		vim.notify("'" .. word .. "' is not a boolean value", vim.log.levels.WARN)
	end
end
vim.api.nvim_create_user_command('ToggleBoolean', toggle_boolean_simple, {})
